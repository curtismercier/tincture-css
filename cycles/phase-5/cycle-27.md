...
id: cycle-27
phase: 5
title: Add motion tokens + transition shorthand
status: queued
created: 2026-04-30
parent_doc: ../v02-scope.md
---

# Cycle 27 — Add motion tokens + transition shorthand

## Status
**queued.** Spec lives in `cycles/v02-scope.md` (cycle table row 27).
