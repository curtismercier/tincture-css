...
id: cycle-21
phase: 5
title: Define axis types + registry shape (TypeScript types)
status: queued
created: 2026-04-30
parent_doc: ../v02-scope.md
---

# Cycle 21 — Define axis types + registry shape (TypeScript types)

## Status
**queued.** Spec lives in `cycles/v02-scope.md` (cycle table row 21).
