...
id: cycle-24
phase: 5
title: Add typography axis (surface, sometimes mood)
status: queued
created: 2026-04-30
parent_doc: ../v02-scope.md
---

# Cycle 24 — Add typography axis (surface, sometimes mood)

## Status
**queued.** Spec lives in `cycles/v02-scope.md` (cycle table row 24).
